...
If any of the above applies to you, Asset Helper is the tool for you

Asset Helper is a tool that analyzes your buildlog and gives you an easily understandable overview over unused asset in your project folder. The results are grouped into folders and file types, making it easy to start cleaning up your project.
...
To open the Asset Helper window, goto "Window->Asset Helper" or press ctrl+h
...
-New feature: Asset Helper settings now allows to exclude assets by path substring
-New feature: Asset "AHSceneOverview" which allows you to locate enabled/disabled and unreferenced scenes
...
- example: AsssetHelper.AHSettings.ExcludeIndividualAssetWithID(string id)
