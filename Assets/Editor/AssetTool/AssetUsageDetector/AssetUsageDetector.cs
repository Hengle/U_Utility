...
namespace AssetTool
{
	...
	public class ReferenceHolder
	{
		...
		public void DrawOnGUI( PathDrawingMode pathDrawingMode )
		{
			...
			if( GUILayout.Button( title, AssetUsageDetector.BoxGUIStyle, AssetUsageDetector.GL_EXPAND_WIDTH, AssetUsageDetector.GL_HEIGHT_30) && clickable )
			{
	...
	public class AssetUsageDetector : EditorWindow
	{
		...
		private bool searchInOpenScenes = false; // Scenes currently open in Hierarchy view
