...
{
    [System.Serializable]
    public class AHSettings : ScriptableObject
    {
        [SerializeField]
        public List<UnityEngine.Object> m_DirectoryExcludes = new List<UnityEngine.Object>();

        [SerializeField]
        public List<AHSerializableSystemType> m_AssetTypeExcludes = new List<AHSerializableSystemType>();
        ...
        internal bool ValidateType(AHSerializableSystemType newtype)
        {
        ...
        {
            AHSettings settings = LoadSettings();
        ...
        public static void ExcludeType(AHSerializableSystemType newtype)
        {
            AHSettings settings = LoadSettings();
        ...
        private static void setDirty(AHSettings settings)
        {
