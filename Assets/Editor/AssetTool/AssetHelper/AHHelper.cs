...
namespace AsssetHelper
{
    internal class AHHelper
    {
        ...
        */
        ...
        internal static AHBuildReport AnalyzeBuildLog()
        {
            AHBuildReport buildReport = new AHBuildReport();
            string UnityEditorLogfile = GetLogFolderPath();
        ...
        internal static void PopulateUnusedList(AHBuildReport buildLog, SortedDictionary<AHSerializableSystemType, bool> validTypeList)
        {
        ...
        /*public static List<Type> GetScriptLevelDependencies(EditorBuildSettingsScene[] ebsScenes)
        {
            ...
            string[] resourcesFolderPaths = AHHelper.GetResourcesDirectories();
