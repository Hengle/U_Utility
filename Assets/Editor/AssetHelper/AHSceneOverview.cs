...
{
    public class AHSceneOverview : EditorWindow
    {
        private static AHSceneOverview m_window;
        ...
        public static AHSceneOverview Instance
        {
            get
            {
                if (m_window != null)
        ...
        private static AHSceneOverview doInit()
        {
            m_IntialGUIColor = GUI.color;

            m_window = EditorWindow.GetWindow<AHSceneOverview>();
            m_window.Show();
        ...
        private void OnGUI()
        {
            ...
            AHSceneOverview.Instance.Repaint();
