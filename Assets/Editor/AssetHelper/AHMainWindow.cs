...
{
    public class AHMainWindow : EditorWindow, ISerializationCallbackReceiver
    {
        public enum AHWindowState
        {
            BuildReport,
            UnusedAssets,
            UnusedScripts
        ...
        [SerializeField]
        public AHSettings settings;

        private AHWindowState m_WindowState = AHWindowState.UnusedAssets;
        private static AHMainWindow m_window;
        ...
        public List<AHProjectFolderInfo> m_ProjectFolderList = new List<AHProjectFolderInfo>();

        //Dictionary and list to help serialization of unusedTypeDict
        public List<AHSerializableSystemType> m_unusedTypeListKeysSerializer = new List<AHSerializableSystemType>();
        public List<bool> m_unusedTypeListValuesSerializer = new List<bool>();
        public SortedDictionary<AHSerializableSystemType, bool> m_unusedTypeDict = new SortedDictionary<AHSerializableSystemType, bool>(new SerializableSystemTypeComparer());

        //Dictionary and list to help serialization of unusedTypeDict
        public List<AHSerializableSystemType> m_usedTypeListKeysSerializer = new List<AHSerializableSystemType>();
        public List<bool> m_usedTypeListValuesSerializer = new List<bool>();
        public SortedDictionary<AHSerializableSystemType, bool> m_usedTypeDict = new SortedDictionary<AHSerializableSystemType, bool>(new SerializableSystemTypeComparer());
        ...
        [SerializeField]
        public AHProjectFolderInfo m_folderMarkedForDeletion = null;
        ...
        [SerializeField]
        private AHBuildReport m_BuildLog;
        ...
        [UnityEditor.MenuItem("Window/Asset Helper _%h", priority = 1)]
        ...
        void OnGUI()
        {
            ...
            if (m_BuildLogLoaded)
            {
                if (m_WindowState == AHWindowState.UnusedAssets)
                    showUnusedAssetsUI();
                else if (m_WindowState == AHWindowState.BuildReport)
                    showBuildReportUI();
            }

            //No need for build to look at unused scripts
            /*if (m_WindowState == AHWindowState.UnusedScripts)
                OnUnusedScriptsUIUpdate();*/
        }

        private void showDefaultHeader()
        {
            EditorGUILayout.LabelField("Asset Helper v2.3", EditorStyles.boldLabel);
        ...
        private void changeState(AHWindowState newState)
        {
        ...
        private void showUnusedAssets()
        {
            ...
            {
                foreach (AHProjectFolderInfo folder in m_ProjectFolderList)
                {
        ...
        private void deleteAllInFolder(AHProjectFolderInfo folder, bool shouldBackup)
        {
            m_folderMarkedForDeletion = null;
        ...
        private void createBackup(List<AssetObjectInfo> objectsToDelete, string mainDirectoryName)
        {
            ...
            string tmpNewFolder = Application.dataPath + "\\..\\AHBackupXXX";
        ...
        private void getObjectsMarkedForDeletion(AHProjectFolderInfo aFInfo, ref List<AssetObjectInfo> objectsToDelete)
        {
        ...
        private void showTypesUI(SortedDictionary<AHSerializableSystemType, bool> typeList)
        {
            EditorGUI.indentLevel = 0;
        ...
        private void drawAssetFolderInfoRecursively(AHProjectFolderInfo assetFolder, int indentLevel)
        {
        ...
        private void getTypesRecursively(AHProjectFolderInfo afi)
        {
        ...
        public static AHMainWindow Instance
        {
            get
            {
                if (m_window != null)
        ...
        internal List<AHProjectFolderInfo> GetFolderList()
        {
            return m_ProjectFolderList;
        }

        internal void AddProjectFolderInfo(AHProjectFolderInfo afInfo)
        {
            m_ProjectFolderList.Add(afInfo);
        }

        internal int GetIndexOf(AHProjectFolderInfo projectFolderInfo)
        {
            return m_ProjectFolderList.IndexOf(projectFolderInfo);
        }

        internal AHProjectFolderInfo GetFolderInfo(string path)
        {
